/*
  Crypto-backed randomness: the single app-wide source of random values, built on
  the Web Crypto API instead of Math.random so Sonar's S2245 PRNG hotspot never
  fires. crypto is a global in both the browser and the Node 20+ SSR runtime.
*/
